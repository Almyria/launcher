...
class Settings {
    ...
    async initRam() {
        ...
        let ram = ramDatabase ? ramDatabase : { ramMin: "1", ramMax: `${defaultMaxRam}` };
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Utiliser la version de Java fournie avec le launcher';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Utiliser la version de Java fournie avec le launcher';
            file.value = '';
